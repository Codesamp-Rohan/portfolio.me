...
function App() {
  ...
  return (
    <>
      ...
      <div
        data-value="about me."
        className="mx-[2rem] mb-[2rem] md:m-[2rem] bg-transparent flex flex-col items-center rounded-2xl p-[2rem] md:p-0 border-0 relative">
        <img
          className="snap-img absolute z-[100] rotate-[-65deg] top-[-40px] md:top-[-100px] w-[30vw]"
